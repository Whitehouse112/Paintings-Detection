import numpy as np
import cv2
from painting_detection import detect_paintings, HW3
from crop import cropROI

video_name = 'VIRB0407.MP4'
...
while video.grab():
    ...
    roi_list, roi_frame, frame_contours = detect_paintings(frame)
    images = cropROI(HW3(frame), roi_list)
